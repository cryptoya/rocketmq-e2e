...
public class ClientInitStepdefs {
    ...
    @And("The {string} set ConsumerGroup\\({string}), SubscriptionExpression\\({string}), Topic\\({string}), MessageListener\\({string})")
    public void theSetConsumerGroupSubscriptionExpressionTopicMessageListener(String arg0, String arg1, String arg2, String arg3, String arg4) {

    }

    @When("Create a {string}, set client config Endpoint\\({string}), RequestTimeout\\({string})")
    public void createASetClientConfigEndpointRequestTimeout(String arg0, String arg1, String arg2) {

    }

    @When("Create a {string}, set client config Endpoint\\({string})")
    public void createASetClientConfigEndpoint(String client, String endpoint) {
